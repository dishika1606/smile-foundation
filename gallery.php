        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="gallery-filter d-none d-sm-block">
                    ...
                    <button class="btn btn-default filter-button" data-filter="covid">Covid Relief</button>
                ...
                <div class="gallery_product text-center col-lg-3 col-md-3 col-sm-4 col-xs-6 filter hdpe">
                    <img src="assets/images/events/image_01.jpg" class="img-responsive">
                    <small class=""><i>
                        <p class="pt-2">Location : Sarang Village, Maharashtra</p>
                        <p>Year: 2022</p>
                        <p>Helped locals build well for irrigation.</p>
                    </i></small>
                </div>

                <div class="gallery_product text-center col-lg-3 col-md-3 col-sm-4 col-xs-6 filter sprinkle">
                ...
                <div class="gallery_product text-center col-lg-3 col-md-3 col-sm-4 col-xs-6 filter irrigation">
                ...
                <div class="gallery_product text-center col-lg-3 col-md-3 col-sm-4 col-xs-6 filter spray">
                ...
                <div class="gallery_product text-center col-lg-3 col-md-4 col-sm-3 col-xs-6 filter irrigation">
