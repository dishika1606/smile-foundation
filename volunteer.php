...
<body>
    ...
    <div class="">
        ...
        <form class="pt-4 col-md-5 m-auto" name="userForm" method="POST" action='volunteer.php'>
            ...
            <div class="form-label-group">
                <label class="col-form-label" for="email">Email (unique to every volunteer) <small>*</small></label>
    ...
    <div style="padding:100px" class="card">
        ...
        <br>
        <p>Click here to confirm data and <b><a style="color:green;" href="volunteer.php">return.</a></b></p>
    </div>
