    ...
    <div class="">
        ...
        <form class="m-auto col-md-5" name="userForm" method="POST" action='donate_success.php'>
            ...
            <div class="form-label-group">
                ...
                <input type="radio" name="mode" value="Credit/Debit card">Credit/Debit card<br>
                <input type="radio" name="mode" value="Net banking">Net banking<br>
                <input type="radio" name="mode" value="Paytm">Paytm<br>
                <input type="radio" name="mode" value="Phone Pay">Phone Pay<br>
