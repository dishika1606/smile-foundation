...
<body>
    ...
    <div class="">
        ...
        <form class="m-auto col-md-5" name="userForm" method="POST" action='donate2.php'>

            <!-- first name -->
            <div class="form-label-group">
                <label for="fname">First name<small>*</small></label>
                <input type="text" class="form-control" name="fname">
                <small id="errorfname"><?php echo $errorname; ?> </small>
            </div>
            <!-- last name -->
            <div class="form-label-group">
                <label for="lname">Last name<small>*</small></label>
                <input type="text" class="form-control" name="lname">
                <small id="errorlname"><?php echo $errorname; ?> </small>
            </div>
